...
export const en: Messages = {
  ...
  freeTools: {
    title: "Free Tools",
    subtitle: "No signup. No fluff. Just tools that work.",
    buildSellSheet: {
      name: "Build sell sheet",
      description:
        "Create a good-better-best comparison sheet for your clients.",
    },
  },
  sellSheet: {
    title: "Build sell sheet",
    subtitle: "Set up a good-better-best comparison for your next proposal.",
