...
export const es: Messages = {
  ...
  freeTools: {
    ...
    subtitle: "Sin registro. Sin rodeos. Herramientas que funcionan.",
    buildSellSheet: {
      name: "Crear hoja comparativa",
      description:
        "Arma una hoja comparativa bueno-mejor-óptimo para tus clientes.",
    },
  },
  sellSheet: {
    title: "Crear hoja comparativa",
    subtitle:
      "Configura una comparación bueno-mejor-óptimo para tu próxima propuesta.",
    companyName: "Nombre de la empresa",
    projectName: "Nombre del proyecto",
    tiersLegend: "Niveles de servicio",
    tierName: "{tier} — nombre",
    tierPrice: "{tier} — precio",
    tierDetails: "{tier} — detalles",
    pricePlaceholder: "$0",
