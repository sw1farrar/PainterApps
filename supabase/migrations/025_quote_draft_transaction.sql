-- Atomic save for quote child entities (rooms, surfaces, line items, tiers)
...
grant execute on function public.save_quote_draft_children(uuid, jsonb, jsonb, jsonb, jsonb) to authenticated;