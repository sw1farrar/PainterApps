-- Spot prime: use 10% of full-coat primer gallons when enabled on baseline / tier config.
...
-- Extend save_quote_draft_children for primer_spot_prime on tier paint config
